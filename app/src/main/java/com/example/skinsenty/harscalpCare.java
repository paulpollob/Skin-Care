...
public class harscalpCare extends AppCompatActivity {
    Button skin_1,skin_2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_harscalp_care);
        ...
        skin_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(harscalpCare.this,scalpcare.class));
            }
        });
        skin_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(harscalpCare.this,conditionerSerum.class));
            }
        });
    }
}